...
class Emojifier {
    ...
    private static void whichEmoji(Face face){
        ...
        final double SMILING_THRESHOLD = .3;
        final double EYE_CLOSED = .5;

        boolean leftEyeOpen = face.getIsLeftEyeOpenProbability() > EYE_CLOSED;
        boolean rightEyeOpen = face.getIsRightEyeOpenProbability() > EYE_CLOSED;
